        ...
        {tabs.map((tab) => (
          <button
            ...
            style={{
              ...
              color: tab.id === activeId ? "var(--lc-accent-text)" : "var(--lc-text-secondary)",
              backgroundColor: tab.id === activeId ? "var(--lc-accent)" : "transparent",
              border: tab.id === activeId ? "none" : "1px solid var(--lc-border)",
