...
export default function ChallengeProofError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[ChallengeProof] error boundary caught:", error);
  }, [error]);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-(--text-muted)">
              The proof submission page encountered an error.
            </p>
          </div>
        </div>
