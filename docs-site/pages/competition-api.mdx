...
Go to [uat.lightchallenge.app/org/new](https://uat.lightchallenge.app/org/new), connect your wallet, and create an organization. You'll receive a **secret API key** — save it immediately, it's shown only once.
