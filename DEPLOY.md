...
### Contracts we reference (do NOT deploy)

| Contract | Address (testnet) | Owned by |
|---|---|---|
| `AIVMInferenceV2` | `0x2d499C52312ca8F0AD3B7A53248113941650bA7E` | Lightchain |
| `LCAIValidatorRegistry` | See `.env` | Lightchain |
