...
export type FitnessRules = {
  type: "fitness";
  /** Metric to evaluate */
  metric: "steps" | "distance_km" | "walking_km" | "active_minutes" | "cycling_km" | "swimming_km" | "hiking_km" | "rowing_km" | "strength_sessions" | "yoga_min" | "hiit_min" | "exercise_time" | "calories";
