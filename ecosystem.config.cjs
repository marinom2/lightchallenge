...
module.exports = {
  apps: [
    ...
    {
      name: "achievement-indexer",
      script: "npx",
      args: "tsx offchain/indexers/achievementIndexer.ts",
      cwd: __dirname,
      restart_delay: 5000,
      max_restarts: 50,
      autorestart: true,
      ...
      env: {
        NODE_ENV: "production",
        ACHIEVEMENT_INDEXER_POLL_MS: "6000",
      },
    },
    {
      name: "achievement-award",
      script: "npx",
      args: "tsx offchain/workers/achievementAwardWorker.ts",
      cwd: __dirname,
      restart_delay: 10000,
      max_restarts: 50,
      autorestart: true,
      ...
      env: {
        NODE_ENV: "production",
        ACHIEVEMENT_AWARD_POLL_MS: "60000",
      },
    },
    {
      name: "ws-gateway",
      script: "npx",
      args: "tsx offchain/workers/wsGateway.ts",
      cwd: __dirname,
      restart_delay: 5000,
      max_restarts: 50,
      autorestart: true,
    ...
    },
    {
      name: "discord-bot",
      script: "npx",
      args: "tsx discord-bot/src/index.ts",
      cwd: __dirname,
      restart_delay: 10000,
      max_restarts: 50,
      autorestart: true,
